...
if __name__ == "__main__":
    ...
    parser.add_argument("--flat_data_fpath", help="fpath for all_data_flat.json")
    parser.add_argument("--minutes_dir", help="directory to find minutes in")
    ...
    main(
        flat_data_fpath=args.flat_data_fpath,
